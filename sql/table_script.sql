...
DROP TABLE IF EXISTS "tbl_run_datetime";
...
(
	...
	"record_values" TEXT,
	FOREIGN KEY
("run_id") REFERENCES "tbl_run_datetime"
("run_id"),
	FOREIGN KEY
("domain_id") REFERENCES "tbl_domain"
("domain_id"),
	FOREIGN KEY
("type_id") REFERENCES "tbl_type"
("type_id")
);
